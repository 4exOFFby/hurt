      ...
      <ResultSection>
        <ResultContainer>
          <Description>
           ...
           Что за фамилия - {user.scare}!? с такой фамилией лучше {DATA_HURT.compare_3[getRandomInt(0,9)]} &#173; 
    ...
    <ResultSection>
      <ResultContainer>
        <Description>
         ...
         {user.name} - звучит, как будто {DATA_HAPPY.compare_2[getRandomInt(0,9)]} &#173; 
         Что за фамилия - {user.scare}!? с такой фамилией лучше {DATA_HAPPY.compare[getRandomInt(0,9)]} &#173; 
         Ты реально зарабатываешь {user.cash}!? {DATA_HAPPY.compare[getRandomInt(0,9)]} &#173;
         Кто в здравом уме мог придумать такую почту - {user.email}!? {DATA_HAPPY.compare[getRandomInt(0,9)]} &#173;
         {user.acceptation}!? А я что просил написать!? С такой внимательностью тебе лучше {DATA_HAPPY.compare[getRandomInt(0,9)]}
        </Description>
        <ResultMoreButton text="Ещё..." onClick={() => {setVisible(2); clearText();}} />
        <ResultBackButton text="На главную" onClick={() => {setVisible(1); clearText(); themeToggler()}} />
      </ResultContainer>
