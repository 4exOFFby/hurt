    ...
    <FormSection>
      <FormContainer>
        ...
        <StyledFormQuastions method="post" action="https://echo.htmlacademy.ru" onChange={e => gedValueHandler(e)}>
          <Quastion text="Как Вас зовут?" id="user-name" name="user-name" type="text" value="value" />
          ...
          <FormAcceptedButton text="Получить оскорбления" type="submit" onClick={() => setVisible(3)}/>
